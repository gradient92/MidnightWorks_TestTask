...
AMidnightW_TestTaskCharacter::AMidnightW_TestTaskCharacter()
{
...
void AMidnightW_TestTaskCharacter::SetupPlayerInputComponent(UInputComponent* PlayerInputComponent)
{
	...
	if (UEnhancedInputComponent* EnhancedInputComponent = Cast<UEnhancedInputComponent>(PlayerInputComponent)) {
		...
		// Moving
		EnhancedInputComponent->BindAction(MoveAction, ETriggerEvent::Triggered, this, &AMidnightW_TestTaskCharacter::Move);

		// Looking
		EnhancedInputComponent->BindAction(LookAction, ETriggerEvent::Triggered, this, &AMidnightW_TestTaskCharacter::Look);
	}
	else
	{
...
void AMidnightW_TestTaskCharacter::Move(const FInputActionValue& Value)
{
	// input is a Vector2D
...
void AMidnightW_TestTaskCharacter::Look(const FInputActionValue& Value)
{
	// input is a Vector2D
